      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            const Text('Activity', style: TextStyle(color: AppColors.textSecondary, fontSize: 13, fontWeight: FontWeight.w600)),
            const SizedBox(height: 8),
            _settingsTile(
              icon: Icons.history,
            ...
            _settingsTile(
              ...
              title: 'Mobile Number',
              onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const AddMobileScreen())),
            ),
            const SizedBox(height: 24),
            _settingsTile(
              icon: Icons.logout,
